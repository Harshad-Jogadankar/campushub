...
const ProjectCollab = (props) => {
  ...
  return (
    <Container>
      <ProjectBox>
        <button onClick={toggleProjectForm}>Make a Project</button>
        ...
        <Content>
          ...
          {filteredProjects
            ...
            .map((project, key) => (
              <Project key={key}>
                <Timestamp>
                  {formatDistanceToNow(new Date(project.timestamp))} ago
                </Timestamp>
                <ProjectDetails>
                  <UserInfo>
                    <img
                      onClick={() => {
                        handleUserClick(project.email);
                      }}
