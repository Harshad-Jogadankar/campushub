          ...
          <a>
            <div>
              ...
              <span className="headline">
                {props.userDetails ? props.userDetails.headline : "headline"}
              </span>
              <span className="branch">
                {props.userDetails ? props.userDetails.branch : "branch"} - sem{" "}
                {props.userDetails ? props.userDetails.semester : "semester"}
              </span>
            </div>
          </a>
        </Widget>
